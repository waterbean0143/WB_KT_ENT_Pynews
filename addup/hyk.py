...
def articles_crawler(url):
    ...
    original_html = requests.get(i,headers=headers, verify=False)
...
news_df.to_csv('{}_{}.csv'.format(search,now.strftime('%Y%m%d_%H시%M분%S초')),encoding='utf-8-sig',index=True)
